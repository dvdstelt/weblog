...
My problem was, that this little (cut-down) piece of code was in a method that was adding SqlParamaters into an array. But as you can see in my example, when you insert the number 10 into *Active*, it won’t get processed, and thus the array will have a SqlParameter that’s null. When some more methods later this is added into the Microsoft Data Access Application Block (yes, the old one), it throws some [weird error](/2006/08/28/Debugging/).
