...
* [Manually adding and configuring the endpoints](/2010/06/19/wcf-simple-example-in-visual-studio-2010-part-2/)
* More to come…

It’s been a long, long time since I wrote the original [WCF Simple Example](/2007/04/20/wcf-simple-example/) post. It was even before Visual Studio 2008 and since then, a lot of things changed. As still a lot of folks place comments and questions to that post, let’s have a look at what we currently have to do to get a service up and running and consume it in a client.
...
![createnewproject](/images/wcf-simple-example-in-visual-studio-2010/2308_createnewproject_5f00_thumb_5f00_555cee4d.png)
...
![AddReference in solution explorer](/images/wcf-simple-example-in-visual-studio-2010/6175_addreference1_5f00_thumb_5f00_07548ed8.png)
![AddReference2](/images/wcf-simple-example-in-visual-studio-2010/8750_addreference2_5f00_thumb_5f00_6739821a.png)
...
![CreateConsoleHost](/images/wcf-simple-example-in-visual-studio-2010/2746_createconsolehost_5f00_thumb_5f00_471e755d.png)
...
On line 4 is the creation of the ServiceHost object. As first argument it receives the implementation of our service as a type. And a base address as second argument. Read [more about base addresses here](/2006/11/29/wcf-part-6-address/) and [more about hosting here](/2006/11/09/wcf-part-3-hosting-the-service/). The type is defined on line 1 and the base address on line 2.Finally on line 5 our host is started.

### WCF4 : Default endpoints

Now here’s a difference in .NET Framework 4.0 because this is not possible in previous version of .NET. Currently the default endpoints are used, which is a new feature to make configuration of your services less of a hassle. I like to explicitly define everything in detail so everyone knows what happens. But for our example, this works quite well. If you’re not using .NET 4.0 you might want to continue to [part 2](/2010/06/19/wcf-simple-example-in-visual-studio-2010-part-2/) of this weblog post, which will be posted later.
...
How can we see what endpoints are configured by default? I have a little script from [way back](/2006/11/28/display-wcf-host-details-code-snippet/) that displays everything currently running. I won’t go into details, just paste the following after the host.Open(); part.
...
Now you should be able to see the endpoints like in the first following screenshot. You can use a browser like Internet Explorer to go to the service uri and look at the default [MEX endpoint](/2006/11/09/wcf-part-4-make-your-service-visible-through-metadata/).

![ConsoleHostWithoutConfig](/images/wcf-simple-example-in-visual-studio-2010/6471_consolehostwithoutconfig_5f00_thumb_5f00_06e85be3.png)
![mexendpointwithoutconfig](/images/wcf-simple-example-in-visual-studio-2010/1200_mexendpointwithoutconfig_5f00_thumb_5f00_7fc91f6a.png)
...
The console window screenshot shows ConsoleHost as namespace, this is incorrect and should be ConsoleClient as the full commandline statement above states.</span>

![CreateProxy1](/images/wcf-simple-example-in-visual-studio-2010/8321_createproxy1_5f00_thumb_5f00_0d9b6566.png)
![CreateProxy2](/images/wcf-simple-example-in-visual-studio-2010/0361_createproxy2_5f00_thumb_5f00_6d8058a8.png)
...
![CreateServiceReference](/images/wcf-simple-example-in-visual-studio-2010/2311_createservicereference_5f00_thumb_5f00_4d654beb.png)
...
Next we’ll extend this blogpost with at least two more, step-by-step blogposts explaining how to manually add endpoints and how to host your service in IIS. You can [read more about it here](/2010/06/19/wcf-simple-example-in-visual-studio-2010-part-2/)