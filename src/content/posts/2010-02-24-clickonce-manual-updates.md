...
1. [Manual check for updates with ClickOnce](/2007/11/05/manual-check-for-updates-with-clickonce/)
2. [Turn off automatic updates with ClickOnce](/2007/11/28/turn-off-automatic-updates-with-clickonce/)
3. [ClickOnce automated build and pfx file](/2008/10/10/clickonce-deployment-signed-manifests-and-automated-builds-and-resolvekeysource-failing/)
4. [Creating ClickOnce deployment files using an automated build and FinalBuilder](/2008/11/26/deploying-clickonce-applications-automated-using-finalbuilder/)
