...
title: Running Vista; Part 2
description: So I’m still running Vista and guess what… I got my first BSOD this morning! I can’t ...
...
tags:
  ...
  - IE7
redirect_from:
  - /dennis/2006/11/21/running-vista-part-2
  - /blogs/dennis/archive/2006/11/21/running-vista-part-2.aspx
---
...
SQL Server 2005 Dev Edition still isn’t installed, I gave up. I hope Microsoft will respond to my plea. In the meantime, I’ve installed [SQL Express SP2 enabled](http://www.microsoft.com/downloads/details.aspx?familyid=8C88D2D6-C5F2-44AC-AA4A-630F3D47474C&displaylang=en) and that went flawlessly.
...
7. IE7 specific : I used to drag the address-bar icon to the address bar, to refresh the page without postback, as explained to me by [Alex Thissen](http://www.alexthissen.nl/weblog/). You have to drag it to the tab now, which could be handy. Problem is, you can’t drag it to any of the other tab-pages. How weird is that? Either fix it so I can drag my link to the address bar, or so that I can drag it to any of the tabs (which I would prefer).
