...
[ ](https://bloggingabout-linux.azurewebsites.net/cfs-file.ashx/__key/CommunityServer.Blogs.Components.WeblogFiles/dennis.metablogapi/3107.cookbookdatabase_5F00_5F2440BF.png)[![](/images/locking-in-sql-server-and-the-nolock-and-readpast-hints/2502_cookbookdatabase_5f00_thumb_5f00_45bc3d85.png)](/wp-content/uploads/2014/01/2502_cookbookdatabase_5f00_thumb_5f00_45bc3d85.png)
**Shared Locks  
...
**ReadCommitted transaction** A regular transaction is done with isolation level ‘ReadCommitted’. This means that you cannot read data that has an exclusive lock on it. This is achieved when you update a row and another transaction tries to read it while you still have your transaction open. Here’s the update code.
...
```
**READPAST hint** Now with the READPAST hint you’re telling SQL Server you do NOT want to read dirty data. Instead, it skips the rows that are locked.
...
Description : Description4
```
**Conclusion** Be very, very aware of the problems you might introduce when using these table hints!

Download the [demo solution](/files/ReadPast.zip) here.
