...
date: 20081001 082107
title: PDC 2008  Sessions & hard drive
description: I just got a question from Dries which sessions I intend to visit during the PDC. Alt...
categories:
    - PDC08
    - Personal
redirect_from:
...
I just got a question from [Dries](https://bloggingabout-linux.azurewebsites.net/blogs/dries/) which [sessions](https://sessions.microsoftpdc.com/ScheduleBuilder.aspx) I intend to visit during the PDC. Although there isn’t a final list yet and especially tracks and times are still missing, I do have some favorites. I’ll post the list below for no reason at all, just that PDC is going through my mind like 24 hours a day right now. Besides [LittleBigPlanet](http://www.littlebigplanet.com/) by the way, although they are hard to match together. Anyway, the list is quite large and I hope I don’t have to choose between 3 or 4 sessions held at once.
