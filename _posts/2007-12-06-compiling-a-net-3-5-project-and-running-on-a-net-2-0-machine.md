...
For those that are still curious after my previous post about [using C# 3.0 features in .NET 2.0](https://bloggingabout.net/2007/12/05/using-c-3-0-from-net-2-0). You can compile any .NET Framework 3.5 project and run it in a .NET Framework 2.0 environment (read, no .NET Framework 3.5 installed) without any problems… as long as there are no dependencies to the .NET 3.5 assemblies!
