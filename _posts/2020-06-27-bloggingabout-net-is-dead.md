...
date: 20200627 125214
title: BloggingAbout.NET is dead
description: BloggingAbout.NET as a (domain)name exists since December 14, 2004. As a community mu...
categories:
    - BloggingAbout.NET
tags:
  - bloggingabout.net
...
redirect_from:
  ...
  - "/blogs/dennis/archive/2020/06/27/bloggingabout-net-is-dead.aspx"
---

BloggingAbout.NET as a (domain)name exists [since December 14, 2004](https://bloggingabout-linux.azurewebsites.net/2004/12/14/bloggingabout-net/). As a community much longer, with the first article posted on [October 21, 2003](https://bloggingabout-linux.azurewebsites.net/2003/10/21/first-post/). It was called Wasabi back then, which brings back a lot of good memories. At some point we ran on Community Server by Telligent, which doesn’t even seem to exist anymore. We started blogging inside CMG about technology but felt we just had to share all the goodness with the rest of the world. 😉 More and more bloggers joined.
